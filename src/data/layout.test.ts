 ...
 */
// D11 rule 4 · a hood over an island cooktop is centred on it: round 48's four
// cases moved in round 69 to islandRule4.test.ts. They stood the cooktop in
// `slot-range` in package A's room, because `slot-cooktop` did not exist yet;
// with the check now asked of the island's cooktop, they are asked in a room
// whose cooking surface is one.
